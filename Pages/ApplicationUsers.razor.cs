...
namespace Nomina.Pages
{
    public partial class ApplicationUsers
    {
        ...
        protected IEnumerable<Nomina.Models.ApplicationUser> users;
        protected RadzenDataGrid<Nomina.Models.ApplicationUser> grid0;
        ...
        protected async Task RowSelect(Nomina.Models.ApplicationUser user)
        {
        ...
        protected async Task DeleteClick(Nomina.Models.ApplicationUser user)
        {
            try
            {
